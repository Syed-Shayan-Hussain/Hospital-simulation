...
function generatepriority(m, a, b, xo, ul, ll) {
...
var xo = parseFloat(document.getElementById("Xo_input").value);
const ul = parseFloat(document.getElementById("upperlimit").value);
const ll = parseFloat(document.getElementById("lowerlimit").value);
 while (i < 1) {
    j = poissonProbability(interarrivalMean, customers);
    let time = 0;
    arrivalTime += interarrivalTime;
